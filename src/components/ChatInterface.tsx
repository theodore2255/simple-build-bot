  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        id: Math.random().toString(36).substring(7),
        type: 'assistant',
        content: 'Based on your uploaded documents, I can help you find relevant information. This is a simulated response that would be generated by analyzing the content of your documents using vector search and an LLM API.',
        timestamp: new Date(),
